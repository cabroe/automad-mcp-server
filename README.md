...
| | |
|---|---|
| **<!-- AUTOGEN:TOOLCOUNT -->8<!-- /AUTOGEN:TOOLCOUNT --> tools** | `pages` · `media` · `shared` · `config` · `site` · `docs` · `theme` · `discover` — each dispatches on an `action` |
...
<!-- AUTOGEN:TOOLCOUNT_WORD -->Eight<!-- /AUTOGEN:TOOLCOUNT_WORD --> tools, each dispatching on `action`:
