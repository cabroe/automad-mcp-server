...
\`@{ +field }\` region. Core block types (v2):

text, image, gallery, pagelist, section, columns, button, quote, code, divider,
video, embed, rss-feed.
...
Per-block templates live under \`blocks/\` (e.g. \`blocks/pagelist/blog.php\`) and
receive the current context. Set variant classes with \`set\` before including:
\`\`\`
